...
import com.franco.securityACELERACION.email.EmailSender;
import com.franco.securityACELERACION.email.EmailService;
...
public class RegistrationService {
    ...
    public String register(RegistrationRequest request) {
        ...
        final String token = userService.signUpUser(new User
